...
const detailCard: NextPage<postProps> = ({ comics }: postProps) => {
    ...
    const urlImage2 = comics.thumbnail.path + '.' + comics.thumbnail.extension;
    ...
    return (
        <>
            ...
            <BodySingle title={"Sample"}>
                <Box sx={{ maxWidth: 900 }} alignItems='center' justifyContent='center' marginTop='10px'>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={6}>
                            ...
                            <Card sx={{ minWidth: 275 }}>
                                ...
                                <CardActions>
                                    <Button variant="contained">{comics.stock > 0 ? "Comprar" : "No hay stock disponible"
}</Button>
                                </CardActions>
                            </Card>
